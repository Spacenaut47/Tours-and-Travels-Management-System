...
public class Destinations extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run(){
        String[] text = new String[]{"JW Marriot Hotel","Four Seasons Hotel","Reddison Blue","Bellagio Hotel","Classio Hotel","The Bay Club Hotel","The taj hotel","Happy Morning Motel","Riverview Hotel","Snowview Hotel","Casesers palace"};
        try{
            for(int i = 0;i < 9;i++){
